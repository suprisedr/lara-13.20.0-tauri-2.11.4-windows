...
export const tools = [
    {
        ...
        description: "Fetch IAS 23 borrowing cost capitalisations for a company. " +
    ...
    },
    {
        ...
        description: "Fetch a single IAS 23 borrowing cost capitalisation by ID with full details. Requires prior login.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Register a new IAS 23 borrowing cost capitalisation. " +
    ...
    },
    {
        ...
        description: "IAS 23.12 Capitalise borrowing costs — record a capitalisation of borrowing costs to the qualifying asset. " +
...
async function handleCapitalise(args) {
    const { id, ...body } = args;
    const result = await apiPost(`/borrowing-costs/${id}/capitalise`, body);
    return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
}
