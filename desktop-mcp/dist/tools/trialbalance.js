...
export const tools = [
    {
        name: "trial_balance",
        description: "Fetch the trial balance for a company over a given date range. " +
...
export async function handle(name, args) {
  ...
  `;
    const data = (await graphqlRequest(query, { companyId: company_id, startDate: start_date, endDate: end_date }, true));
