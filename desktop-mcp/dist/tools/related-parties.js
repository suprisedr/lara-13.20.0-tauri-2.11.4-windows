...
export const tools = [
    {
        ...
        description: "Fetch IAS 24 related parties for a company. " +
    ...
    },
    {
        ...
        description: "Fetch a single IAS 24 related party by ID with full details. Requires prior login.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Register a new IAS 24 related party. " +
    ...
    },
    {
        ...
        description: "Update an IAS 24 related party's details. " +
            "Requires prior login." +
            FLAG_RULE,
        inputSchema: {
            type: "object",
    ...
    },
    {
        ...
        description: "Fetch all IAS 24 transactions for a specific related party. " +
    ...
    },
    {
        ...
        description: "Record a new IAS 24 related party transaction. " +
