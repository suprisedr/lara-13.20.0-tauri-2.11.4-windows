...
export const tools = [
    {
        ...
        description: "Fetch IAS 38 intangible assets on the register for a company. " +
    ...
    },
    {
        ...
        description: "Fetch a single IAS 38 intangible by ID, including its current carrying amount, accumulated amortisation, " +
    ...
    },
    {
        ...
        description: "Register a new IAS 38 intangible asset (software, patent, trademark, goodwill, customer list, licence, etc.). " +
    ...
    },
    {
        ...
        description: "Update mutable fields on an IAS 38 intangible (name, reference, category, residual_value, useful_life_years, " +
    ...
    },
    {
        ...
        description: "Dispose of an IAS 38 intangible asset (sale, retirement, abandonment). " +
    ...
    },
    {
        ...
        description: "IAS 38.75 Revaluation Model — revalue an intangible whose class uses the revaluation model. " +
    ...
    },
    {
        ...
        description: "IAS 36 Impairment — recognise a write-down of an intangible when its recoverable amount falls below its carrying amount. " +
    ...
    },
    {
        ...
        description: "IAS 36.114 Impairment Reversal — reverse a previously recognised impairment when the recoverable amount has recovered. " +
    ...
    },
    {
        ...
        description: "IAS 38.18/.20 Subsequent Expenditure — capitalise a subsequent cost that extends the future economic benefits of an " +
            "existing intangible. " +
...
async function handleGetIntangibles(args) {
...
async function handleGetIntangible(args) {
    const { id } = args;
    const result = await apiGet(`/intangibles/${id}`);
    return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
}
async function handleCreateIntangible(args) {
    const body = {
...
async function handleUpdateIntangible(args) {
    const { id } = args;
    const body = {};
    for (const k of [
        "name",
...
async function handleDisposeIntangible(args) {
