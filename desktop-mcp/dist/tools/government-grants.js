...
export const tools = [
    {
        ...
        description: "Fetch IAS 20 government grants for a company. " +
    ...
    },
    {
        ...
        description: "Fetch a single IAS 20 government grant by ID with full detail including events history." + FLAG_RULE,
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Register a new IAS 20 government grant. " +
    ...
    },
    {
        ...
        description: "Recognise a government grant (IAS 20.7). AI posts the recognition journal." + FLAG_RULE,
        inputSchema: {
            type: "object",
            properties: {
                grant_id: { type: "number", description: "Government grant ID" },
    ...
    },
    {
        ...
        description: "Amortise a government grant to income (IAS 20.12). AI posts the amortisation journal." + FLAG_RULE,
        inputSchema: {
            type: "object",
            properties: {
                grant_id: { type: "number", description: "Government grant ID" },
    ...
    },
    {
        ...
        description: "Record a government grant refund (IAS 20.32). AI posts the refund journal." + FLAG_RULE,
        inputSchema: {
            type: "object",
            properties: {
                grant_id: { type: "number", description: "Government grant ID" },
