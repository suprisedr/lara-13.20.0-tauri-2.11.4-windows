...
export const tools = [
    {
        ...
        description: "Fetch IAS 12 deferred tax items for a company. " +
    ...
    },
    {
        ...
        description: "Fetch a single IAS 12 deferred tax item by ID with full detail." + FLAG_RULE,
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Register a new IAS 12 deferred tax item. " +
    ...
    },
    {
        ...
        description: "Remeasure a deferred tax item with new carrying amount and tax base (IAS 12.37). AI posts the adjustment journal." + FLAG_RULE,
        inputSchema: {
            type: "object",
            properties: {
                item_id: { type: "number", description: "Deferred tax item ID" },
    ...
    },
    {
        ...
        description: "Reverse a deferred tax item when the temporary difference reverses (IAS 12.41). AI posts the reversal journal." + FLAG_RULE,
        inputSchema: {
            type: "object",
            properties: {
                item_id: { type: "number", description: "Deferred tax item ID" },
