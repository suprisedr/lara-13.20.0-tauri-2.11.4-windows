...
export const tools: Tool[] = [
  {
    name: "get_provisions",
    description:
      "Fetch IAS 37 provisions, contingent liabilities and contingent assets for a company. " +
  ...
  },
  {
    name: "get_provision",
    description:
      "Fetch a single IAS 37 provision by ID with full detail including events history." + FLAG_RULE,
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "Register a new IAS 37 provision, contingent liability, or contingent asset. " +
  ...
  },
  {
    ...
    description:
      "Remeasure a provision to a new best estimate (IAS 37.36). AI posts the adjustment journal." + FLAG_RULE,
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "Record utilisation/settlement against a provision (IAS 37.61). AI posts the journal." + FLAG_RULE,
    inputSchema: {
      type: "object" as const,
      properties: {
        provision_id: { type: "number" },
  ...
  },
  {
    ...
    description:
      "Reverse a provision when outflow is no longer probable (IAS 37.59). AI posts the reversal journal." + FLAG_RULE,
    inputSchema: {
      type: "object" as const,
      properties: {
        provision_id: { type: "number" },
