...
export const tools: Tool[] = [
  {
    ...
    description:
      "Fetch the PPE (Property, Plant & Equipment) classes configured for a company. " +
...
async function handleGetPpeClasses(args: Record<string, unknown>): Promise<ToolResult> {
  ...
  const data = (await graphqlRequest(query, { companyId: company_id }, true)) as {
    ppeClasses: unknown[];
  };
