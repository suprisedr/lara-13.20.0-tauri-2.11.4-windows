...
export const tools: Tool[] = [
  {
    ...
    description:
      "Fetch IFRS 2 share-based payment arrangements for a company. " +
  ...
  },
  {
    ...
    description:
      "Fetch a single IFRS 2 share-based payment arrangement by ID with full detail including events history." + FLAG_RULE,
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "Register a new IFRS 2 share-based payment arrangement. " +
  ...
  },
  {
    ...
    description:
      "Record a vesting expense for a share-based payment arrangement (IFRS 2.7). AI posts the journal." + FLAG_RULE,
    inputSchema: {
      type: "object" as const,
      properties: {
        arrangement_id: { type: "number", description: "Arrangement ID" },
  ...
  },
  {
    ...
    description:
      "Exercise instruments in a share-based payment arrangement (IFRS 2.23). AI posts the journal." + FLAG_RULE,
    inputSchema: {
      type: "object" as const,
      properties: {
        arrangement_id: { type: "number", description: "Arrangement ID" },
  ...
  },
  {
    ...
    description:
      "Forfeit instruments in a share-based payment arrangement (IFRS 2.28). AI posts the reversal journal." + FLAG_RULE,
    inputSchema: {
      type: "object" as const,
      properties: {
        arrangement_id: { type: "number", description: "Arrangement ID" },
