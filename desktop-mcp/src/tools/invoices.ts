...
export const tools: Tool[] = [
  {
    name: "invoices",
    description:
      "Search invoices for a company. At least one filter must be provided. Requires prior login.\n" +
      "\n" +
...
export async function handle(
  ...
  const { company_id, invoice_number, customer_name, date, status, total_min, total_max } = args as {
    company_id: string;
