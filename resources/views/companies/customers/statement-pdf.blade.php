    ...
    <table style="width:100%;border-collapse:collapse;">
        <tr>
            <td style="vertical-align:top;width:50%;">
                <div style="font-weight:bold;font-size:9pt;margin-bottom:2px;">{{ $customer->name }}</div>
                ...
                @if ($customer->address)<div style="white-space:pre-line;">{{ $customer->address }}</div>@endif
            </td>
            <td style="vertical-align:top;width:50%;">
                <div class="doc-title">STATEMENT</div>
                <div class="meta-line">Vendor: <strong>{{ $company->registered_name }}</strong></div>
                <div class="meta-line">
