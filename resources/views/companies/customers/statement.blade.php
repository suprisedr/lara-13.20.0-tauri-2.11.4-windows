...
@section('title', $company->registered_name . ' — ' . $customer->name . ' Statement')
...
<div style="display:flex;align-items:center;gap:0.65rem;flex-wrap:wrap;">
                        <a href="{{ route('companies.customers.statement.pdf', [$company, $customer, 'start_date' => $startDate, 'end_date' => $endDate]) }}" class="mgmt-btn primary" target="_blank">
                            Download PDF
                        </a>
                    </div>
                </div>
                ...
                {{-- Date range filter --}}
                <form method="GET" action="{{ route('companies.customers.statement', [$company, $customer]) }}" class="stmt-filter-bar">
                    <div class="field">
                            ...
                            <tbody>
                                ...
                                @forelse ($lines as $line)
                                    <tr>
                                        ...
                                        <td>{{ $line['type'] }}</td>
                                        <td>
                                            <a class="row-link" href="{{ $line['link'] }}">{{ $line['description'] }}</a>
                                        </td>
