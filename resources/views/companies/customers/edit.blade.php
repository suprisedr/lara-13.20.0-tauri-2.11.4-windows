...
@section('title', $company->registered_name . ' — Edit Customer')
                ...
                <form method="POST" action="{{ route('companies.customers.update', [$company, $customer]) }}">
                    ...
                    <div class="co-card">
                        <div class="co-card-head">
                            <div>
                                <div class="co-section-heading"><p class="co-section-label">Customers</p><h2>Edit Customer</h2></div>
                            </div>
</div>
                                ...
                                <div class="inv-field" style="grid-column:span 2;">
                                    <label class="inv-status-field">
                                        ...
                                        <input type="checkbox" id="is_active" name="is_active" value="1"
                                            {{ old('is_active', $customer->is_active ? '1' : '0') == '1' ? 'checked' : '' }}>
