        ...
        <div class="co-body">
            ...
            <main class="co-main">
                ...
                <form id="edit-employee-form" method="POST" action="{{ route('companies.payroll.employees.update', [$company, $employee]) }}">
                    ...
                    <div class="cust-doc">
                        <div class="cust-doc-body">
                            <div class="doc-title">Edit Employee</div>
                            <p style="font-size:0.78rem;color:#555;margin:0.2rem 0 0.75rem;">{{ $employee->employee_number }}</p>
                            <hr class="divider">
                ...
                <form method="POST" action="{{ route('companies.payroll.employees.destroy', [$company, $employee]) }}"
                    ...
                    @csrf @method('DELETE')
                    <button type="submit" class="mgmt-btn danger">Remove Employee</button>
                </form>
