            ...
            <main class="co-main">
                ...
                <form method="POST" action="{{ route('companies.supplier-invoices.update', [$company, $supplierInvoice]) }}" class="cn-form" id="sinv-form">
                    ...
                    <div class="cn-section">
                        ...
                        <textarea name="notes" id="notes" rows="3" style="width:100%;max-width:600px;border:1px solid #ccc;padding:0.4rem 0.6rem;font-size:0.8rem;font-family:inherit;">{{ old('notes', $supplierInvoice->notes) }}</textarea>
                    </div>

                    <div style="display:flex;gap:1rem;align-items:center;">
                        <button type="submit" class="btn-submit">Save Changes</button>
                        <a href="{{ route('companies.supplier-invoices.show', [$company, $supplierInvoice]) }}" style="font-size:0.78rem;color:#6b7280;text-decoration:none;">Cancel</a>
                    </div>
                </form>
