...
@push('styles')
    ...
    <style>
        ...
        .supp-hit { padding:0.5rem 0.8rem; cursor:pointer; font-size:0.8rem; border-bottom:1px solid #f4fafc; }
        .supp-hit:hover { background:#f4fafc; }
            ...
            <main class="co-main">
                ...
                <form method="POST" action="{{ route('companies.supplier-invoices.store', $company) }}" class="cn-form" id="sinv-form">
                    ...
                    <div style="display:flex;gap:1rem;align-items:center;">
                        ...
                        <a href="{{ route('companies.supplier-invoices.index', $company) }}" style="font-size:0.78rem;color:#5a7186;text-decoration:none;">Cancel</a>
                    </div>
                </form>
