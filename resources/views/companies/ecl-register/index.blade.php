...
@push('styles')
    ...
    <style>
        ...
        .ecl-metric { border-top:1.5pt solid #1a345b;background:#fff;padding:6pt 8pt; }
        .ecl-metric-label { font-size:5pt;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:#5a7186;margin-bottom:2pt; }
        .ecl-metric-value { font-size:10pt;font-weight:800;font-family:"DejaVu Sans Mono",monospace;color:#1a345b; }
        ...
        .ecl-rate-form .field label { display:block;font-size:5.5pt;font-weight:700;letter-spacing:0.07em;text-transform:uppercase;color:#5a7186;margin-bottom:2pt; }
        .ecl-rate-form .input-pct { position:relative; }
        .ecl-rate-form input[type='number'] { width:100%;border:1px solid #9ec1f5;padding:3pt 12pt 3pt 4pt;font-size:7pt;font-family:"DejaVu Sans Mono",monospace;box-sizing:border-box;color:#1a345b; }
        .ecl-rate-form input[type='number']:focus { outline:none;border-color:#1a345b; }
        .ecl-rate-form .input-pct::after { content:'%';position:absolute;right:4pt;top:50%;transform:translateY(-50%);color:#6f869b;font-size:6.5pt;pointer-events:none; }
        .ifrs-box { border-top:1.5pt solid #1a345b;border-bottom:0.5pt solid #9ec1f5;padding:6pt 8pt;margin-top:8pt;font-size:7pt;line-height:1.6;background:#f7fbfd; }
        .ifrs-box h4 { font-size:6.5pt;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;color:#005bf0;margin:0 0 3pt; }
        .ifrs-box p { margin:0 0 4pt;color:#5a7186; }
        .ifrs-box ul { margin:0 0 4pt 10pt;padding:0;color:#5a7186; }
                ...
                <div class="reg-doc">
                    <div class="reg-doc-body">
                        ...
                        <form method="GET" action="{{ route('companies.ecl-register.index', $company) }}" style="display:flex;gap:4pt;align-items:flex-end;margin:6pt 0 8pt;">
                            <div>
                                <label style="display:block;font-size:5.5pt;font-weight:700;text-transform:uppercase;letter-spacing:0.07em;color:#5a7186;margin-bottom:2pt;">As at</label>
                                <input type="date" name="as_of_date" value="{{ $asOfDate }}" style="border:1px solid #9ec1f5;padding:3pt 4pt;font-size:7pt;font-family: "Century Gothic", "URW Gothic", "Avant Garde", Futura, "Avenir Next", Avenir, "Trebuchet MS", Helvetica, Arial, "DejaVu Sans", sans-serif;color:#1a345b;">
                            </div>
