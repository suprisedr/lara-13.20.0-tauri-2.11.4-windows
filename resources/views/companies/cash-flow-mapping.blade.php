...
@push('styles')
    ...
    <style>
        ...
        .cfm-table th { text-align:left; font-size:0.66rem; font-weight:700; letter-spacing:0.06em; text-transform:uppercase; color:#5a7186; padding:0.5rem 0.6rem; border-bottom:1.5px solid #d3e2f5; }
        .cfm-table td { padding:0.4rem 0.6rem; border-bottom:0.5px solid #f4fafc; }
        .cfm-group { font-size:0.72rem; font-weight:800; text-transform:uppercase; letter-spacing:0.08em; color:#005bf0; background:#f4fafc; padding:0.45rem 0.6rem; }
        .cfm-code { color:#6f869b; font-family:monospace; white-space:nowrap; }
        .cfm-table select { font-size:0.78rem; font-family:inherit; border:1.5px solid #d3e2f5; border-radius:0; padding:0.25rem 0.45rem; background:#fff; }
                ...
                <div class="co-card">
                    <div class="co-card-head">
                        <div>
                            ...
                            <p style="font-size:0.8rem;color:#5a7186;margin:0;max-width:60ch;">
                    ...
                    <form method="POST" action="{{ route('companies.cash-flow-mapping.update', $company) }}" style="padding:1rem 1.25rem 1.5rem;">
                        ...
                        <div style="margin-top:1.25rem;position:sticky;bottom:0;background:#fff;padding-top:0.5rem;">
                            <button type="submit"
                                style="background:#005bf0;color:#fff;border:none;border-radius:0;padding:0.5rem 1.4rem;font-size:0.82rem;font-weight:700;cursor:pointer;font-family:inherit;">Save Mapping</button>
                        </div>
                    </form>
                </div>
            </main>
