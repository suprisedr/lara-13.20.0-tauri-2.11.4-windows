...
@push('styles')
    ...
    <style>
        ...
        .section-header { font-weight:700;font-size:7.5pt;text-transform:uppercase;letter-spacing:0.06em;border-bottom:1.5px solid #16355c;padding-bottom:2pt;margin-bottom:4pt;color:#16355c; }
        ...
        .history-row { display:flex;align-items:flex-start;gap:6pt;padding:5pt 0;border-bottom:1px solid #ddebf5;font-size:7pt; }
        ...
        .history-date { color:#7a90a5;font-size:6.5pt;white-space:nowrap;min-width:56pt; }
        .history-desc { flex:1; }
        ...
        .as-field input,.as-field select { width:100%;border:1px solid #c9dff0;padding:3pt 5pt;font-size:7pt;font-family:inherit;color:#16355c;background:#fff;outline:none;box-sizing:border-box;height:16pt;border-radius:0; }
...
<div style="display:flex;align-items:center;gap:4pt;flex-wrap:wrap;">
                    ...
                    <div class="cust-doc-body">
                            ...
                            <tr>
                                <td style="vertical-align:top;width:55%;">
                                    ...
                                    @if ($biologicalAsset->reference)
                                        <div style="font-size:7pt;color:#7a90a5;margin-top:0.2rem;">{{ $biologicalAsset->reference }}</div>
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align:top;width:50%;text-align:right;">
                                    ...
                                    @if ($biologicalAsset->notes)
                                        <div style="color:#7a90a5;font-style:italic;font-size:6.5pt;margin-top:0.3rem;">{{ $biologicalAsset->notes }}</div>
                                    @endif
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="summary-table">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="amt" style="color:#0079c8;">{{ $biologicalAsset->fair_value !== null ? 'R ' . number_format((float) $biologicalAsset->fair_value, 2) : "\u{2014}" }}</span>
                                </td>
                                <td>
                        ...
                        <div style="margin-top:12pt;">
                            ...
                            <div id="history-container">
                                <p style="color:#7a90a5;font-style:italic;font-size:6.5pt;">Loading history…</p>
                            </div>
                        </div>
                        ...
                        <div class="action-section">
                            ...
                            <div class="action-panel" id="panel-fair-value">
                                <div class="action-panel-head" onclick="togglePanel('fair-value')">
                                    <span class="action-panel-title">Fair value adjustment <small style="font-weight:400;color:#7a90a5;">(IAS 41.12)</small></span>
                            ...
                            <div class="action-panel" id="panel-harvest">
                                <div class="action-panel-head" onclick="togglePanel('harvest')">
                                    <span class="action-panel-title">Harvest <small style="font-weight:400;color:#7a90a5;">(IAS 41.13)</small></span>
                                    <span class="action-panel-chevron">&#9660;</span>
                                </div>
                                <div class="action-panel-body">
                            ...
                            <div class="action-panel" id="panel-natural-increase">
                                <div class="action-panel-head" onclick="togglePanel('natural-increase')">
                                    <span class="action-panel-title">Natural increase <small style="font-weight:400;color:#7a90a5;">(births / growth)</small></span>
                                    <span class="action-panel-chevron">&#9660;</span>
                                </div>
                                <div class="action-panel-body">
                            ...
                            <div class="action-panel" id="panel-mortality">
                                <div class="action-panel-head" onclick="togglePanel('mortality')">
                                    <span class="action-panel-title">Mortality / loss <small style="font-weight:400;color:#7a90a5;">(deaths, disease, etc.)</small></span>
                                    <span class="action-panel-chevron">&#9660;</span>
                                </div>
                                <div class="action-panel-body">
                            ...
                            <div class="action-panel" id="panel-dispose">
                                <div class="action-panel-head" onclick="togglePanel('dispose')">
                                    <span class="action-panel-title">Dispose / sell <small style="font-weight:400;color:#7a90a5;">(IAS 41.27)</small></span>
                                    <span class="action-panel-chevron">&#9660;</span>
                                </div>
                                <div class="action-panel-body">
    ...
    <script>
        ...
        (function() {
            ...
            fetch('{{ route("companies.biological-assets.history", [$company, $biologicalAsset]) }}')
                .then(r => r.json())
                .then(events => {
                    if (!events.length) { container.innerHTML = '<p style="color:#7a90a5;font-style:italic;font-size:6.5pt;">No movement history yet.</p>'; return; }
                    container.innerHTML = '';
                    events.forEach(function(e) {
                        ...
                        div.innerHTML =
                            ...
                            '<span class="history-desc">' + e.description +
                                (e.quantity_change ? ' <span style="color:#7a90a5;font-size:6pt;">(' + e.quantity_change + ')</span>' : '') +
                            '</span>' +
    ...
    <div id="edit-modal"
        ...
        <div style="background:#fff;width:100%;max-width:520px;border:1px solid #16355c;border-radius:0;box-shadow:0 20px 60px rgba(0,0,0,0.4);overflow:hidden;margin:0 auto;">
            <div style="display:flex;align-items:center;justify-content:space-between;padding:9pt 12pt;border-bottom:1.5px solid #16355c;">
                <h3 style="font-size:1.05rem;font-weight:800;letter-spacing:0.04em;margin:0;text-transform:uppercase;color:#16355c;">Edit Biological Asset</h3>
