...
<a href="{{ route('companies.assets.index', $company) }}" style="margin-left:auto;">
                ...
                <div class="reg-doc">
                    <div class="reg-doc-body">
                        ...
                        <p style="font-size:7pt;color:#4a5f78;margin:0.2rem 0 0.75rem;">IAS 2 inventory classification. Items are grouped by type for disclosure and valuation.</p>
                            ...
                            <table class="reg-table" style="margin-bottom:1rem;">
                                ...
                                <tbody>
                                    ...
                                    @if ($grouped->has('unclassified'))
                                        ...
                                        @endphp
                                        <tr>
                                            <td style="font-weight:700;color:#7a90a5;">Unclassified</td>
                        ...
                        @else
                            <p style="color:#7a90a5;font-size:7pt;font-style:italic;margin-bottom:1rem;">No inventory items yet.</p>
                        @endif

                        @if ($serviceItems->isNotEmpty())
                            <div style="margin-top:0.5rem;font-size:7pt;color:#4a5f78;">
                ...
                <div class="reg-doc">
                    <div class="reg-doc-body">
                        ...
                        @if ($stockItems->isEmpty())
                            <p style="color:#7a90a5;font-style:italic;font-size:7pt;">No inventory items yet. Add your first item below.</p>
                        @else
                            @php
                                $totalStockValue = 0.0;
                                $totalQtyOnHand  = 0.0;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($item->inventory_type)
                                                        <span class="type-badge" style="font-size:6pt;font-weight:700;padding:0.1rem 0.4rem;border:1px solid #c9dff0;background:#f5faff;color:#4a5f78;text-transform:uppercase;letter-spacing:0.04em;display:inline-block;">{{ $typeLabels[$item->inventory_type->value] ?? $item->inventory_type->value }}</span>
                                                    @else
                                                        <span style="color:#7a90a5;font-size:6.5pt;">—</span>
                                                    @endif
                                                </td>
                                                ...
                                                <td style="text-align:right;">
                                                    <div class="reg-row-actions" style="display:flex;align-items:center;gap:0.5rem;justify-content:flex-end;">
                                                        <button type="button" style="background:none;border:none;font-size:6.5pt;color:#16355c;text-decoration:underline;cursor:pointer;font-family:inherit;padding:0;"
                        ...
                        <div class="add-panel open" id="panel-edit-item" style="display:none;">
                            <div class="add-panel-body" style="display:block;">
                                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:5pt;">
                                    <span style="font-size:6.5pt;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;color:#16355c;">Edit Item</span>
                                    <button type="button" onclick="closeEditPanel()" style="background:none;border:none;font-size:9pt;color:#7a90a5;cursor:pointer;">&times;</button>
                                </div>
                                <form id="edit-form" method="POST">
                                    ...
                                    <div class="af-row">
                                        ...
                                        <div style="display:flex;align-items:center;gap:4pt;padding-bottom:3pt;">
                                            ...
                                            <label for="ef-is_active" style="font-size:6.5pt;color:#16355c;text-transform:none;letter-spacing:0;margin:0;cursor:pointer;">Active</label>
                                        </div>
                                    </div>
                                    <div class="af-submit">
                ...
                <div class="reg-doc">
                    <div class="reg-doc-body">
                        ...
                        <p style="font-size:7pt;color:#4a5f78;margin:0.2rem 0 0.75rem;">Services, labour, and non-stock items used for invoicing. No stock or IAS 2 tracking.</p>

                        <hr class="reg-divider">

                        @if ($serviceItems->isEmpty())
                            <p style="color:#7a90a5;font-style:italic;font-size:7pt;">No service items yet.</p>
                        @else
                            <div style="overflow-x:auto;">
                                <table class="reg-table">
                                    <thead>
