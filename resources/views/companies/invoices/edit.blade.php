...
@section('content')
                        ...
                        <div class="invoice-doc-body">
                                ...
                                <div class="invoice-payment">
                                    ...
                                    <div style="background:#faf9ff;border:1px solid #ede9fe;border-radius:0;padding:1rem 1.25rem;display:flex;flex-wrap:wrap;gap:1.25rem 2.5rem;">
                                        ...
                                        <div>
                                            ...
                                            <p style="font-size:0.855rem;font-weight:600;color:#5e17eb;margin:0;font-family:'Courier New',monospace;" id="payment-ref">{{ old('invoice_number', $invoice->invoice_number) }}</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div style="margin-bottom:1.75rem;">
                                ...
                                <textarea name="notes" id="notes" rows="3"
                                    ...
                                    onblur="this.style.borderColor='#ddd6fe';this.style.boxShadow='none';this.style.background='#faf9ff'">{{ old('notes', $invoice->notes) }}</textarea>
                            </div>
    ...
    <script>
        ...
        function addLineItem(invId = null, qty = 1) {
            ...
            const stockHint = selected && !selected.is_service ? `<div style="font-size:0.65rem;color:#6b7280;margin-top:1px;">${selected.quantity_on_hand} available</div>` : '';
