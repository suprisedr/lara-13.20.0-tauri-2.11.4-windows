    ...
    <div class="co-wrap">
        ...
        <div class="co-body">
            ...
            <main class="co-main">
                ...
                <form method="POST" action="{{ route('companies.invoices.store', $company) }}" id="invoice-form">
                    @csrf
                        ...
                        <div class="invoice-doc-body">
                                ...
                                <div class="invoice-payment">
                                    ...
                                    <div style="background:#faf9ff;border:1px solid #ede9fe;border-radius:0;padding:1rem 1.25rem;display:flex;flex-wrap:wrap;gap:1.25rem 2.5rem;">
                                        ...
                                        <div>
                                            ...
                                            <p style="font-size:0.855rem;font-weight:600;color:#5e17eb;margin:0;font-family:'Courier New',monospace;" id="payment-ref">{{ old('invoice_number', $nextNumber) }}</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="invoice-doc-footer">
                                ...
                                <div style="display:flex;gap:0.65rem;align-items:center;">
                                    <a href="{{ route('companies.invoices.index', $company) }}" class="inv-action-btn inv-action-cancel">
                                        Cancel
                                    </a>
