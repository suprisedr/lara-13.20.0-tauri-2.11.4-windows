...
@section('title', $company->registered_name . ' — New Purchase Order')
    ...
    <div class="co-wrap">
        ...
        <div class="co-body">
            ...
            <main class="co-main">
                ...
                <form method="POST" action="{{ route('companies.purchase-orders.store', $company) }}" class="cn-form" id="po-form">
                    @csrf
                    ...
                    <div class="cn-section">
                        ...
                        <div class="cn-grid three">
                            <div class="cn-field">
                                ...
                                <input type="text" name="po_number" value="{{ old('po_number', $nextNumber) }}" required>
